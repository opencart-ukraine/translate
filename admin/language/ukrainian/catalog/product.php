...
$_['entry_points']           = 'Бали';
$_['entry_option_points']    = 'Опція балів';
$_['entry_subtract']         = 'Зняти зі складу';
...
$_['help_points']            = 'Кількість бонусних балів необхідна для покупки цього товару. Якщо Ви не хочете купляти цей товар за бонусні бали залиште 0.';
$_['help_category']          = '(Автозаповнення)';
$_['help_filter']            = '(Автозаповнення)';
$_['help_download']          = '(Автозаповнення)';
$_['help_related']           = '(Автозаповнення)';
$_['help_tag']          	 = 'виддідяти комою';
